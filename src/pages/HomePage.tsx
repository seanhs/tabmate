...
import { Receipt, Share2, Zap, ArrowRight, Check, Loader2, Clock, X } from 'lucide-react'
      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-20">
        <div className="max-w-2xl mx-auto text-center animate-fade-in">
          ...
          <p className="mt-5 text-lg text-neutral-600 leading-relaxed">
            Create a trip, add what everyone spent, and instantly see the
        ...
        <section className="max-w-6xl mx-auto px-6 pt-4 pb-10">
          <div className="max-w-2xl mx-auto">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-sm font-semibold text-neutral-700">Your trips</h2>
            ...
            <p className="mt-3 text-xs text-neutral-400">
              Trips are remembered in this browser. Share links still work on any device.
            </p>
      ...
      <section className="bg-white border-y border-neutral-200">
        <div className="max-w-6xl mx-auto px-6 py-14">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: '01', title: 'Create a trip', text: 'Name it, list the people involved, and you get a shareable link instantly.' },
              { step: '02', title: 'Add expenses', text: 'Anyone with the link logs what they paid and who it covers. No math required.' },
              { step: '03', title: 'Settle smart', text: 'We calculate the fewest payments to make everyone whole. Tap to pay via Venmo or Cash App.' },
            ].map((s, i) => (
              <div key={i} className="text-center">
                <div className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-primary-50 text-primary-600 font-bold text-sm mb-4">
                  {s.step}
                </div>
            ...
            <form onSubmit={handleCreate} className="space-y-5">
              <div>
                ...
                <input
                  id="tripName"
                  className="input"
                  placeholder="e.g. Vegas 2026, Cabin Weekend"
                  value={tripName}
